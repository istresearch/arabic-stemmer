...
class ArabicStemmer(BaseStemmer):
        ...
        for v_1 in range (len(self.current), 0, -1):
            ...
            try:
                ...
                try:
                    ...
                    # substring, line 263
                    among_var = self.find_among(ArabicStemmer.a_0, 160)
                    if among_var == 0:
                        raise lab1()
                    # ], line 263
    ...
    def __r_Normalize_post(self):
        ...
        try:
            ...
            self.ket = self.cursor
            # substring, line 340
            among_var = self.find_among_b(ArabicStemmer.a_1, 5)
            if among_var == 0:
                raise lab0()
            # ], line 340
            self.bra = self.cursor
            ...
            for v_3 in range (self.I_word_len, 0, -1):
                ...
                try:
                    ...
                    try:
                        ...
                        self.bra = self.cursor
                        # substring, line 351
                        among_var = self.find_among(ArabicStemmer.a_2, 5)
                        if among_var == 0:
                            raise lab3()
                        # ], line 351
                        self.ket = self.cursor
    ...
    def __r_Checks1(self):
        ...
        self.bra = self.cursor
        # substring, line 365
        among_var = self.find_among(ArabicStemmer.a_3, 4)
        if among_var == 0:
            return False
        # ], line 365
        self.ket = self.cursor
    ...
    def __r_Checks2(self):
        ...
        self.ket = self.cursor
        # substring, line 375
        among_var = self.find_among_b(ArabicStemmer.a_4, 1)
        if among_var == 0:
            return False
        # ], line 375
        self.bra = self.cursor
    ...
    def __r_Prefix_Step1(self):
        ...
        self.bra = self.cursor
        # substring, line 384
        among_var = self.find_among(ArabicStemmer.a_5, 5)
        if among_var == 0:
            return False
        # ], line 384
        self.ket = self.cursor
    ...
    def __r_Prefix_Step2a(self):
        ...
        self.bra = self.cursor
        # substring, line 396
        among_var = self.find_among(ArabicStemmer.a_6, 2)
        if among_var == 0:
            return False
        # ], line 396
        self.ket = self.cursor
    ...
    def __r_Prefix_Step2b(self):
        ...
        self.bra = self.cursor
        # substring, line 406
        among_var = self.find_among(ArabicStemmer.a_7, 2)
        if among_var == 0:
            return False
        # ], line 406
        self.ket = self.cursor
    ...
    def __r_Prefix_Step3a_Noun(self):
        ...
        self.bra = self.cursor
        # substring, line 414
        among_var = self.find_among(ArabicStemmer.a_8, 4)
        if among_var == 0:
            return False
        # ], line 414
        self.ket = self.cursor
    ...
    def __r_Prefix_Step3b_Noun(self):
        ...
        self.bra = self.cursor
        # substring, line 423
        among_var = self.find_among(ArabicStemmer.a_9, 5)
        if among_var == 0:
            return False
        # ], line 423
        self.ket = self.cursor
    ...
    def __r_Prefix_Step3_Verb(self):
        ...
        self.bra = self.cursor
        # substring, line 435
        among_var = self.find_among(ArabicStemmer.a_10, 4)
        if among_var == 0:
            return False
        # ], line 435
        self.ket = self.cursor
    ...
    def __r_Prefix_Step4_Verb(self):
        ...
        self.bra = self.cursor
        # substring, line 446
        among_var = self.find_among(ArabicStemmer.a_11, 3)
        if among_var == 0:
            return False
        # ], line 446
        self.ket = self.cursor
    ...
    def __r_Suffix_Noun_Step1a(self):
        ...
        self.ket = self.cursor
        # substring, line 456
        among_var = self.find_among_b(ArabicStemmer.a_12, 10)
        if among_var == 0:
            return False
        # ], line 456
        self.bra = self.cursor
    ...
    def __r_Suffix_Noun_Step1b(self):
        ...
        self.ket = self.cursor
        # substring, line 464
        among_var = self.find_among_b(ArabicStemmer.a_13, 1)
        if among_var == 0:
            return False
        # ], line 464
        self.bra = self.cursor
    ...
    def __r_Suffix_Noun_Step2a(self):
        ...
        self.ket = self.cursor
        # substring, line 471
        among_var = self.find_among_b(ArabicStemmer.a_14, 3)
        if among_var == 0:
            return False
        # ], line 471
        self.bra = self.cursor
    ...
    def __r_Suffix_Noun_Step2b(self):
        ...
        self.ket = self.cursor
        # substring, line 478
        among_var = self.find_among_b(ArabicStemmer.a_15, 1)
        if among_var == 0:
            return False
        # ], line 478
        self.bra = self.cursor
    ...
    def __r_Suffix_Noun_Step2c1(self):
        ...
        self.ket = self.cursor
        # substring, line 485
        among_var = self.find_among_b(ArabicStemmer.a_16, 1)
        if among_var == 0:
            return False
        # ], line 485
        self.bra = self.cursor
    ...
    def __r_Suffix_Noun_Step2c2(self):
        ...
        self.ket = self.cursor
        # substring, line 491
        among_var = self.find_among_b(ArabicStemmer.a_17, 1)
        if among_var == 0:
            return False
        # ], line 491
        self.bra = self.cursor
    ...
    def __r_Suffix_Noun_Step3(self):
        ...
        self.ket = self.cursor
        # substring, line 497
        among_var = self.find_among_b(ArabicStemmer.a_18, 1)
        if among_var == 0:
            return False
        # ], line 497
        self.bra = self.cursor
    ...
    def __r_Suffix_Verb_Step1(self):
        ...
        self.ket = self.cursor
        # substring, line 504
        among_var = self.find_among_b(ArabicStemmer.a_19, 12)
        if among_var == 0:
            return False
        # ], line 504
        self.bra = self.cursor
    ...
    def __r_Suffix_Verb_Step2a(self):
        ...
        self.ket = self.cursor
        # substring, line 512
        among_var = self.find_among_b(ArabicStemmer.a_20, 11)
        if among_var == 0:
            return False
        # ], line 512
        self.bra = self.cursor
    ...
    def __r_Suffix_Verb_Step2b(self):
        ...
        self.ket = self.cursor
        # substring, line 523
        among_var = self.find_among_b(ArabicStemmer.a_21, 2)
        if among_var == 0:
            return False
        # ], line 523
        self.bra = self.cursor
    ...
    def __r_Suffix_Verb_Step2c(self):
        ...
        self.ket = self.cursor
        # substring, line 531
        among_var = self.find_among_b(ArabicStemmer.a_22, 2)
        if among_var == 0:
            return False
        # ], line 531
        self.bra = self.cursor
    ...
    def __r_Suffix_All_alef_maqsura(self):
        ...
        self.ket = self.cursor
        # substring, line 539
        among_var = self.find_among_b(ArabicStemmer.a_23, 1)
        if among_var == 0:
            return False
        # ], line 539
        self.bra = self.cursor
